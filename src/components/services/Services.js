...
const Services = () => { 
  ...
  useEffect(() => {
    // Функція для виклику анімацій після завантаження
    const loadAnimations = () => {
      setAnimationsLoaded(true);
      Animation();
    };

    // Симуляція завантаження анімацій (замініть це на реальний код завантаження)
    setTimeout(loadAnimations, 5000); // Завантажте анімації після 5 секунд

    // Очистка слухача подій анімацій при розмонтуванні компонента
    return () => {
      // Додайте код очистки, якщо потрібно
    };
  }, []);
...
let defaultCoord;
cardWrapper.onmousedown = (e) => {
defaultCoord = e.pageX;
console.log(e);
}

cardWrapper.addEventListener('click', (e) => { console.log('click', e)})

cardWrapper.mousemove = (e) => {
...
function moveCards(dur=0){
  ...
  <div className='services-wrapper'>
    {/* <div className="cards-wrapper">
      <div className="cards">
        <button className="card-SMM" tabindex="-1">
          <h2>SMM</h2>
        </button>
      </div>

    <div className="cards">
      <button className="card-Target" tabindex="-1">
        <h2>Facebook & Instagram Ads</h2>
      </button>
    </div>

    <div className="cards">
      <button className="card-Google-Ads" tabindex="-1">
        <h2>Google Ads</h2>
      </button>
    </div>

    <div className="cards">
      <button className="card-seo" tabindex="-1">
        <h2>SEO</h2>
      </button>
    </div>

    <div className="cards">
      <button className="card-3D" tabindex="-1">
        <h2>3D Motion</h2>
      </button>
    </div>

    <div className="cards">
      <button className="card-web-design" tabindex="-1">
        <h2>Graphic & Web-design</h2>
      </button>
    </div>

    <div className="cards">
      <button className="card-pr" tabindex="-1">
        <h2>PR</h2>
      </button>
    </div>

    <div className="cards">
      <button className="card- branding" tabindex="-1">
        <h2>Branding</h2>
      </button>
    </div>

    <div className="cards">
      <button className="card-bord" tabindex="-1">
